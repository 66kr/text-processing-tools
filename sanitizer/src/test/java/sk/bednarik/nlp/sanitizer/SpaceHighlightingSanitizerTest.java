...
public class SpaceHighlightingSanitizerTest {
  ...
  public void testSanitization() {
    ...
    System.out.println(SpaceHighlightingSanitizer.sanitize("\n" +
        ...
        "             Navrhovateľ, Anita Hrmová – AEM zberné suroviny, Veternícka 169/66, 967 01 Kremnica,  IČO 00321125 požiadala   dňa 17.04.2015 Okresný úrad Žiar nad Hronom, odbor staros